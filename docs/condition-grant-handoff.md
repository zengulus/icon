...
- Unresolved: **467** (was 470) — 8 class-trait, 43 job-trait, **256 talent**,
  144 mastery, 16 limit-break.
...
- Top implementable blockers (fresh numbers): range-modifier 16/71,
  area-define 12/58, aura 12/30, interrupt-modifier 12/24, terrain-create
  11/52, mark-modifier 11/33.
- Residual (non-implementable): 81.
