...
| K-P7 | Talent subfamily folds (remaining) | resource-management, action-type-change, charge-state, shove-modifier | talent fold extensions | ~180 remaining talents | Exact-ID slices, each with positive/negative/replay |
