...
Counts below were reconciled 2026-09-05 from `npm run audit:automation`,
...
| Programs with no unsupported clause | 469 |
| Clauses with no unsupported text | 1,606 |
| Explicitly unsupported clauses | 3,095 |
...
| Class traits | 13 | ✔ | 7 programs without unsupported clauses | 6 | mixed 3–6 |
| Job traits | 65 | ✔ | 29 | 36 | wired rows 6–7; rest 3 with kernel need recorded |
...
| Foe traits | 691 traceable units | ✔ | 115 keyword rows (79 full, 36 partial) | 590 traceable units | keyword rows 6–7; prose 3 (table-facing) |
...
| Camp fixtures / features | 16 / 85 | ✔ | 0 | 101 | 2–3 |
| Reward rules | 9 | ✔ | 0 | 9 | 2 |
| Narrative rolls | — | ✔ | zero-rating, boons/curses, crits | — | 6 |
| Character lifecycle | — | ✔ schema v5, migration v1–v5, import/export; narrative selections persist permanent canonical IDs | creation→combat entry DONE; settlement + attrition handoff DONE (P1); camp/interlude sheet transitions DONE, playable scene flow NOT STARTED | — | 7 for the deterministic core |
...
`npm run audit:class-job-census`; never hand-edit). Current shape: 425 unresolved Class/Job units
(6 class-trait, 36 job-trait, 238 talent, 129 mastery, 16 limit-break); the
