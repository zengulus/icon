...
| Scope / Clock (U8 underlay) (`claim:foundations:u8-authoritative`) | docs/rules-foundations.md | AUTHORITATIVE | U8 re-certified after a whole-consumer residual audit, combat-cleanup routing repair, replay proof, and u8-scope-clock-routing mutation guard; no strict fidelity scope |
