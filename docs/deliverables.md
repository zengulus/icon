...
| Movement & forced movement | PARTIAL | `movement.ts`, movement-triggers kernel | Standard/dash/difficult/dangerous/elevation/Flying/Rush/Shove/Collide done; Teleport/Place/Swap shared primitives; swaps prevalidate the whole destination permutation against pre-swap state and apply every leg or none (P4 consolidates) |
