...
import { TacticalViewport, type InteractionMode, type TableTool, type TacticalViewportProps } from '../vtt/tactical-viewport.js';

// Keep the original page-level surface stable for existing room consumers;
// the implementation itself is dependency-free in `vtt/tactical-viewport`.
export { TacticalViewport };
export type { InteractionMode, TableTool, TacticalViewportProps };
