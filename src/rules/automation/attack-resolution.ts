 ...
 */
export function attackDamageProvenance(intent: Pick<AttackIntent, 'elevationModifier' | 'trueStrike'>): AttackDamageProvenance {
  return {
...
export function resolveAttackRoll(intent: AttackIntent, dice: DiceSource): AttackRoll {
  ...
  return { d20, boon, total, hit, critical, evasionRoll, trueStrike, autoHit, ...damageProvenance, netBoon };
}
