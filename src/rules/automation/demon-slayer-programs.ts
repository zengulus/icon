...
import type { RuleDuration, RuleMutation, RuleProgramCompilation, RuleResolver, RuleResolverRegistry } from './types.js';
import {
...
const demonCutterEffects: RuleResolver = (context) => {
  ...
  const mutations: RuleMutation[] = [
    conditionMutation(context, target.id, 'slashed'),
  ];
